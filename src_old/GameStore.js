...
exports.createGame = function(size, bet, cb) {
  var gameId = uuidv1()
  var game = {
    id: gameId,
    players: [],
...
exports.getSize = function (gameId) {
  return games[gameId].size
};
...
exports.resetGame= function(gameId) {
  f.createField(gameId,games[gameId].size.h,games[gameId].size.w)
  games[gameId].next=-1
}
